...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "Analog Sensitivity",
      NULL,
      "Set the sensitivity of the gamepad's analog sticks. Lower values equate to slower movement speeds. Some games (e.g. Gorf) require a sensitivity of 100% for correct operation.",
      NULL,
      NULL,
      {
         { "10",  "10%" },
